# @movement-labs/wallet-adapter-vue

## 1.0.1

### Patch Changes

- 5e1d3b7: Revert @movement-labs/wallet-adapter-core dependency version to 5.0.0
...
- 3968a90: Fix bundle size, bump @movement-labs/wallet-adapter-core to 4.16.0
...
- 1cbe660: Add @movement-labs/wallet-adapter-vue@0.1.0

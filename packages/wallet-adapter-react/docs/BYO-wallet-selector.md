...
```tsx
import { WalletItem, WalletItemProps } from "@movement-labs/wallet-adapter-react";
...
```tsx
import { AptosPrivacyPolicy } from "@movement-labs/wallet-adapter-react";
